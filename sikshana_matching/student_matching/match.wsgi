...
class result:
	...
	if str(inputs.sikshana_value)!='' and str(inputs.klp_value)!='':
		...
		db1.query('insert into student_match_found_three values($studentcode,$studentname,$klpcode,$klpname)',queryvalues)
